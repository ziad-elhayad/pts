  ...
  return (
    <section id="mice-section" className="mx-auto max-w-[92rem] border-t border-pts-line bg-pts-black/10">
      ...
      >
        ...
        {/* Final CTA card */}
        <div className="w-[38vw] flex-shrink-0 flex flex-col justify-center px-16 bg-pts-deep/20">
          ...
          <h3 className="font-heading text-2xl text-pts-gold-2 tracking-[0.15em] leading-[1.3] uppercase mb-12 max-w-sm font-light">
