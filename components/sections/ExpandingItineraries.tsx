...
export function ExpandingItineraries() {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-[90vh] min-h-[600px] w-full items-stretch">
          ...
          return (
            <div
              ...
              className={clsx(
                ...
                isActive ? "flex-[4.5] z-10" : "flex-[1] z-0 brightness-[0.48] hover:brightness-[0.68]",
              )}
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-pts-black/25 via-transparent to-pts-black/88" />
              <div
                className={clsx(
                  "absolute inset-0 bg-pts-deep/45 transition-opacity duration-500",
              ...
              <div className="absolute inset-0 flex flex-col justify-between overflow-hidden p-10 lg:p-14">
                    ...
                    <h3
                      className={clsx(
                        ...
                        isActive
                          ...
                          : "translate-y-2 text-base [writing-mode:vertical-rl] rotate-180",
                      )}
                    >
                      {item.title}
                    </h3>
              ...
              <div className="pointer-events-none absolute right-8 top-10 lux-heading text-[0.42rem] tracking-[0.4em] text-pts-gold/30">
                0{index + 1}
              </div>
            </div>
          );
        ...
        <div className="group relative flex h-full w-16 shrink-0 cursor-pointer flex-col items-center justify-center overflow-hidden border-l border-pts-gold/10 bg-pts-deep/80 transition-colors duration-700 hover:bg-pts-gold/10">
